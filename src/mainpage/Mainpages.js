...
export default function Mainpages() {
  return (
    <>
      <header
        class="jumbotron blockcode text-content"
        style={{ height: "85vh" }}
      >
              ...
              <section className="row">
                <article className="col" style={{ paddingLeft: "25px" }}>
                  <h1 className="card-title">
                    ...
                    <br /> ผลงานดี สะดวก ไร้ปัญหาการทิ้งงาน
                  </h1>

                  <p className="card-text">
                    ช่างมืออาชีพ ไม่มีประวัติอาชญากรรม งานเสร็จตรงเวลา
      ...
      <main className="container py-4 text-content">
