    ...
    <div className="search container">
      ...
      <div className="search-card-container card-container">
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            onClick={() => handleCategoryClick("ระบบน้ำ")}
          >
            <img
        ...
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            href="#indownpage"
            onClick={() => handleCategoryClick("ระบบไฟ")}
          >
            <img
              src={require("../Photo/img2.jpg")}
              className="card-img-top p-2"
        ...
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            href="#indownpage"
            onClick={() => handleCategoryClick("เครื่องใช้ไฟฟ้า")}
          >
            <img
              src={require("../Photo/img2.jpg")}
              className="card-img-top p-2"
        ...
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            href="#indownpage"
            onClick={() => handleCategoryClick("โครงสร้าง")}
          >
            <img
              src={require("../Photo/img2.jpg")}
              className="card-img-top p-2"
        ...
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            href="#indownpage"
            onClick={() => handleCategoryClick("บริการและซ่อมบำรุง")}
          >
            <img
              src={require("../Photo/img2.jpg")}
              className="card-img-top p-2"
        ...
        <a href="#indownpage" style={{ textDecoration: "none" }}>
          <button
            className="card ca"
            href="#indownpage"
            onClick={() => handleCategoryClick("เบ็ดเตล็ด")}
          >
            <img
              src={require("../Photo/img2.jpg")}
              className="card-img-top p-2"
