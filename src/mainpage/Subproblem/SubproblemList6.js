    ...
    <div className="subproblem-container">
      <div className="form-content">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          >
            <option value={600}>ช่างสี</option>
            <option value={601}>ช่างกระเบื้อง</option>
            <option value={602}>สวน</option>
            <option value={603}>ผ้าม่าน-มู่ลี่-ฉากกั้นห้อง</option>
            <option value={604}>วอลเปเปอร์</option>
            <option value={605}>เฟอร์นิเจอร์</option>
            <option value={606}>กล้องวงจรปิด</option>
            <option value={607}>สัญญาณกันขโมย</option>
            <option value={608}>เครื่องดูดควัน-ปล่องควัน</option>
            <option value={609}>เครื่องกรองน้ำ</option>
            <option value={610}>พัดลมระบายอากาศ ลูกหมุนระบายอากาศ</option>
          </select>
