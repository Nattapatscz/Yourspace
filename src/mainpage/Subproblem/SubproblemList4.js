...
const SubproblemList4 = () => {
  ...
  const [job_type_id, setJobTypeID] = useState("400");
    ...
    <div className="subproblem-container">
      <div className="form-content">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          >
            <option value={400}>ช่างทาสี</option>
            <option value={401}>มุ้งลวด</option>
            <option value={402}>พื้น</option>
            <option value={403}>หลังคา-ดาดฟ้า</option>
            <option value={404}>กระจก</option>
            <option value={405}>ผนัง</option>
            <option value={406}>ฝ้า-เพดาน</option>
            <option value={407}>รางน้ำฝน</option>
            <option value={408}>ประตู</option>
            <option value={409}>หน้าต่าง</option>
            <option value={410}>บันได</option>
            <option value={411}>กันสาด</option>
            <option value={412}>คิ้ว บัว จบ วงกบ</option>
            <option value={413}>รั้ว-เหล็กดัด-ตะแกรง-ลูกกรง</option>
          </select>
