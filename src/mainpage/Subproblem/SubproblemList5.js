...
const SubproblemList5 = () => {
  ...
  const [job_type_id, setJobTypeID] = useState("500");
    ...
    <div className="subproblem-container">
      <div className="form-content">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          >
            <option value={500}>ทำความสะอาดบ่อดักไขมัน</option>
            <option value={501}>กำจัดปลวก มด แมลงและสัตว์รบกวน</option>
            <option value={502}>ทำความสะอาดแบบ Big Cleaning</option>
            <option value={503}>บริการกำจัดไรฝุ่นหรือทำความสะอาดที่นอน</option>
            <option value={504}>บริการทำความสะอาด</option>
          </select>
